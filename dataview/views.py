...
def caregiver_contact(request,caregiver_charm_id):
    caregiver = Caregiver.objects.get(charm_project_identifier=caregiver_charm_id)
    caregiver_personal_contact_a_name = Name.objects.filter(caregiverpersonalcontact__caregiver_fk__charm_project_identifier=caregiver_charm_id).filter(caregiverpersonalcontact__caregiver_contact_type='PR')
    return render(request=request,template_name='dataview/caregiver_contact.html',context={'caregiver':caregiver,
                                                                                           'caregiver_personal_contact_a_name':caregiver_personal_contact_a_name})