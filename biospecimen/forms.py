...
class ProcessedBloodForm(forms.Form):
    ...
    vacutainer_centrifuge_start_time = forms.DateTimeField(widget=forms.TextInput(attrs={'class': "datetimepicker"}))
    vacutainer_centrifuge_end_time = forms.DateTimeField(widget=forms.TextInput(attrs={'class': "datetimepicker"}))
    plasma_purple_cap_200_ml_all_collected = forms.ChoiceField(required=False,choices=YES_NO)
    plasma_purple_cap_200_ml_number_collected = forms.IntegerField(required=False)
