...
$('#partial_aliquot_7ml_1').hide();
$('#partial_aliquot_7ml_1_amount').hide();
$('#partial_aliquot_7ml_2').hide();
$('#partial_aliquot_7ml_2_amount').hide();
$('#partial_aliquot_7ml_3').hide();
$('#partial_aliquot_7ml_3_amount').hide();
$('#partial_aliquot_7ml_4').hide();
...
$('#id_processed_form-partial_aliquot_7ml_1').click(function() {
  $('#partial_aliquot_7ml_1_amount')[this.checked ? "show" : "hide"]();
});

$('#id_processed_form-partial_aliquot_7ml_2').click(function() {
  $('#partial_aliquot_7ml_2_amount')[this.checked ? "show" : "hide"]();
});

$('#id_processed_form-partial_aliquot_7ml_3').click(function() {
  $('#partial_aliquot_7ml_3_amount')[this.checked ? "show" : "hide"]();
});

$('#id_processed_form-partial_aliquot_7ml_4').click(function() {
  $('#partial_aliquot_7ml_4_amount')[this.checked ? "show" : "hide"]();
});
...
document.getElementById('id_processed_form-partial_aliquot_7ml_1_amount').addEventListener('change', function () {
    var style = this.value != '' ? 'block' : 'none';
    document.getElementById('partial_aliquot_7ml_2').style.display = style;
});

document.getElementById('id_processed_form-partial_aliquot_7ml_2_amount').addEventListener('change', function () {
    var style = this.value != '' ? 'block' : 'none';
    document.getElementById('partial_aliquot_7ml_3').style.display = style;
});

document.getElementById('id_processed_form-partial_aliquot_7ml_3_amount').addEventListener('change', function () {
    var style = this.value != '' ? 'block' : 'none';
    document.getElementById('partial_aliquot_7ml_4').style.display = style;
});
