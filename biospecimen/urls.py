...
urlpatterns = [
    ...
    re_path(r"^caregiver/(?P<caregiver_charm_id>\w+)/(?P<caregiver_bio_pk>[\d]+)/entry/blood/$", biospecimen_views.caregiver_biospecimen_blood_entry, name='caregiver_biospecimen_blood_entry'),
