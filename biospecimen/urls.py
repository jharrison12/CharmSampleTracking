...
urlpatterns = [
    ...
    re_path(r"^caregiver/(?P<caregiver_charm_id>\w+)/(?P<caregiver_bio_pk>[\d]+)/entry/hairandsaliva/$", caregiver_biospecimen.caregiver_biospecimen_entry_hair_saliva, name='caregiver_biospecimen_entry_hair_urine'),
