...
urlpatterns = [
    ...
    re_path(r"^caregiver/(?P<caregiver_charm_id>\w+)/(?P<caregiver_bio_pk>[\d]+)/shipped_wsu/post/$",biospecimen_views.caregiver_biospecimen_shipped_wsu, name='caregiver_biospecimen_shipped_wsu'),
