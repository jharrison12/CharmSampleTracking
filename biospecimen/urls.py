...
urlpatterns = [
    ...
    re_path(r"^caregiver/(?P<caregiver_charm_id>\w+)/(?P<caregiver_bio_pk>[\d]+)/frozen_blood/post/$", caregiver_biospecimen.caregiver_biospecimen_frozen_blood_post, name='caregiver_biospecimen_frozen_blood_post'),
