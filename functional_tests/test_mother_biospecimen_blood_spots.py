...
class MotherBioSpecimenBloodspotsTest(FunctionalTest):
    ...
    def test_user_can_see_bio_blood_spot_information(self):
        ...
        self.browser.get(f'{self.browser.current_url}biospecimen/caregiver/P7000/bloodspots/F/history/')
        ...
        #
        # self.browser.get(self.live_server_url)
        # self.browser.get(f'{self.browser.current_url}biospecimen/caregiver/P7001/bloodspots/F/')
        #
        ...
        # self.browser.get(self.live_server_url)
        # self.browser.get(f'{self.browser.current_url}biospecimen/caregiver/P7002/bloodspots/F/')
        #
        # form = self.browser.find_element(By.TAG_NAME, 'form').text
