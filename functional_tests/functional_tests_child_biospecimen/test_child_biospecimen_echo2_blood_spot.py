...
class ChildBioSpecimenEntryBloodSpot(FunctionalTest):
    ...
    def test_user_can_choose_status_of_child_blood_spots_twelve_to_thirteen_months_chooses_kit_sent_shipped_wsu(self):
        # User visits the caregiver biospecimen page and sees blood_spots
        ...
        body_text = self.webpage_text()
        self.assertIn('In Person or Remote: In Person', body_text)
        self.assertNotIn('number of cards', body_text.lower())
