...
class ChildBioSpecimenEntryBloodSpotZerotoFiveMonths(FunctionalTest):
    ...
    def test_of_child_blood_spots_0_to_5_months_kit_sent_collected_incentive_shipped_wsu_received_wsu_and_shipped_echo(self):
        ...
        # User sees shipped to wsu form and submits a date time
    ...
    def test_user_can_choose_status_of_blood_spots_0_5_months_information_chooses_declined(self):
        # User visits the caregiver biospecimen page and sees blood_spots
        primary_key = self.return_child_bio_pk('4100F1', 'S', 'ZF')
        self.browser.get(self.live_server_url)
        self.browser.get(f'{self.browser.current_url}biospecimen/child/4100F1/{primary_key}/initial/')
...
class ChildBioSpecimenEntryBloodSpotTwelvetoTwentyThreeMonths(FunctionalTest):
    ...
    def test_user_can_choose_status_of_blood_spots_twelve_to_thirteen_months_not_collected(self):
    ...
    def test_user_can_choose_status_of_blood_spots_twelve_to_thirteen_months_information_chooses_declined(self):
        # User visits the caregiver biospecimen page and sees blood_spots
        primary_key = self.return_child_bio_pk('4100F1', 'S', 'TT')
        self.browser.get(self.live_server_url)
        self.browser.get(f'{self.browser.current_url}biospecimen/child/4100F1/{primary_key}/initial/')
    ...
    def test_blood_spots_twelve_to_thirteen_months_kit_sent_collected_incentive_shipped_echo(self):
        # User visits the caregiver biospecimen page and sees blood_spots
        primary_key = self.return_child_bio_pk('4100F1', 'S', 'TT')
        self.browser.get(self.live_server_url)
        self.browser.get(f'{self.browser.current_url}biospecimen/child/4100F1/{primary_key}/initial/')
