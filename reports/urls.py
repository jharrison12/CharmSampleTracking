...
urlpatterns = [
    ...
    re_path(r"^received_at_wsu_report/urine/$", reports.received_at_wsu_report_report_urine, name='received_at_wsu_report_report_urine'),
    re_path(r"^shipped_to_echo_report/urine/$", reports.shipped_to_echo_report_report_urine, name='shipped_to_echo_report_report_urine'),
