...
urlpatterns = [
    ...
    re_path(r"^biospecimen_report/blood/$", reports.biospecimen_report_blood, name='biospecimen_report_blood'),
    ...
    re_path(r"^processed_report/blood/$", reports.processed_report_blood, name='processed_report_blood'),
    re_path(r"^frozen_report/blood/$", reports.frozen_report_blood, name='frozen_report_blood'),
